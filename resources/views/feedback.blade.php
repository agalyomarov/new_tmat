...
<body cz-shortcut-listen="true">
    ...
    <div style="position: absolute; width: 900px; height: 47px; z-index: 3; left: 85px; top: -40px" id="layer3">
        <ul id="nav">
            <li><a href="http://ihtier.net/tex_poderjka.php#"><b>Ваш баланс</b></a>
                <ul>
            ...
            <li><a href="http://ihtier.net/tex_poderjka.php#"><b>Клиентам</b></a>
                <ul>
                                ...
                                <td valign="top">
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" style="width:100%;height:30px;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="cen">
                                                    <center><b>Техническая поддержка.<br> По всем вопросам можете писать через эти данные.</b></center><br>
                                                    <hr>

                                                    <center><b>Администратор:<br>

                                                            <br>icq - 701518858<br>

                                                            <b>telegram - skalatv<br> </b></b></center>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="height: 5px;">
