                                ...
                                <td class="cen">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td><strong>
                                                        <h2>Название пакета: <font color="red">Big Bang 52E - Telekarta 85E</font>
                                                        </h2>
                                                    </strong></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td colspan="2"><strong><img style="float:left" width="170" height="100" src="{{ asset('images/alemtv52.jpg') }}"></strong></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <fieldset>
