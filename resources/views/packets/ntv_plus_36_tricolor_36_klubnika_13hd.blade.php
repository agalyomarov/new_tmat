                                ...
                                <td class="cen">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td><strong>
                                                        <h2>Название пакета: <font color="red">NTV Plus_36 - Tricolor_36 - Klubnika_13 HD</font>
                                                        </h2>
                                                    </strong></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td colspan="2"><strong><img style="float:left" width="170" height="100" src="{{ asset('images/vip56.jpg') }}"></strong></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <fieldset>
