                            ...
                            <tr>
                                <td height="37px">
                                    <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
                                        <tbody>
                                            <tr>
                                                <td style="width:5px;height:37px;"><img src="/images/_lef_1.gif" width="5px" height="37px" alt="" border="0"></td>
                                ...
                                <td class="cen">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td><strong>
                                                        <h2>Название пакета: <font color="red">Vip_all</font>
                                                        </h2>
                                                    </strong></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td colspan="2"><strong><img style="float:left" width="170" height="100" src="{{ asset('images/vip2.jpg') }}"></strong></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <fieldset>
                                        ...
                                        <table class="list" width="100%" style="border-collapse: collapse" border="1" bordercolor="#C0C0C0">
                                            <tbody>
                                                ...
                                                <tr onmouseover="this.style.backgroundColor='#D2E0F0';" onmouseout="this.style.backgroundColor='#ffffff';" class="norm">
                                                    ...
                                                    <td width="773">
                                                        <p align="center"> TV Vlaanderen 19.2E
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr onmouseover="this.style.backgroundColor='#D2E0F0';" onmouseout="this.style.backgroundColor='#ffffff';" class="alt">
                                                ...
                                                <tr onmouseover="this.style.backgroundColor='#D2E0F0';" onmouseout="this.style.backgroundColor='#ffffff';" class="alt">
                                                    ...
                                                    <td width="773">
                                                        <p align="center"> Setanta Sports 31E
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr onmouseover="this.style.backgroundColor='#D2E0F0';" onmouseout="this.style.backgroundColor='#ffffff';" class="norm">
                                                ...
                                                <tr onmouseover="this.style.backgroundColor='#D2E0F0';" onmouseout="this.style.backgroundColor='#ffffff';" class="norm">
                                                    ...
                                                    <td width="773">
                                                        <p align="center"> Sky Germany 19E
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr onmouseover="this.style.backgroundColor='#D2E0F0';" onmouseout="this.style.backgroundColor='#ffffff';" class="alt">
                                                    ...
                                                    <td width="773">
                                                        <p align="center"> 000004,000008,00000C,000010
                                                        </p>
                                                    </td>
                                                    <td width="773">
                                                        <p align="center"> 705
                                                ...
                                                <tr onmouseover="this.style.backgroundColor='#D2E0F0';" onmouseout="this.style.backgroundColor='#ffffff';" class="norm">
                                                    ...
                                                    <td width="773">
                                                        <p align="center"> Big Bang 52E | Telekarta 85E
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr onmouseover="this.style.backgroundColor='#D2E0F0';" onmouseout="this.style.backgroundColor='#ffffff';" class="alt">
                                                    ...
                                                    <td width="773">
                                                        <p align="center"> Kontinent_85 HD
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr onmouseover="this.style.backgroundColor='#D2E0F0';" onmouseout="this.style.backgroundColor='#ffffff';" class="norm">
