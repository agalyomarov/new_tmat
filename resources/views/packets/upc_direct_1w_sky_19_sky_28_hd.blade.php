                                ...
                                <td class="cen">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td><strong>
                                                        <h2>Название пакета: <font color="red">UPC Direct 1w - Sky19 - Sky28 HD</font>
                                                        </h2>
                                                    </strong></td>
                                                <td>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2"><strong><img style="float:left" width="170" height="100" src="{{ asset('images/vip19.jpg') }}"></strong></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <fieldset>
