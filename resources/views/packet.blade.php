...
<body cz-shortcut-listen="true">
    ...
    <div style="position: absolute; width: 900px; height: 47px; z-index: 3; left: 85px; top: -40px" id="layer3">
        <ul id="nav">
            <li><a href="http://ihtier.net/packets.php?selected_user=romankotelnikov#"><b>Ваш баланс</b></a>
                <ul>
            ...
            <li><a href="http://ihtier.net/packets.php?selected_user=romankotelnikov#"><b>Клиентам</b></a>
                <ul>
