...
<body cz-shortcut-listen="true">
    ...
    <div style="position: absolute; width: 900px; height: 47px; z-index: 3; left: 85px; top: -40px" id="layer3">
        <ul id="nav">
            <li><a href="http://ihtier.net/ports.php#"><b>Ваш баланс</b></a>
                <ul>
            ...
            <li><a href="http://ihtier.net/ports.php#"><b>Клиентам</b></a>
                <ul>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" style="width:100%;height:30px;">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="cen">
                                                    <center>
                                                        <h2>Таблица портов для протокола<span lang="ru"></span>:
                                                            <font color="blue"><b><span lang="ru">Cccam</span></b></font>
                                                        </h2>
                                                    </center>
                                                    <center>
                                                        <table width="532" border="1">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="34" height="28">Порт</td>
                                                                    <td width="152" height="28">
                                                                        <p align="center"><span lang="ru">Протокол</span></p>
                                                                    </td>
                                                                    <td width="127" height="28">
                                                                        <p align="center">Название пакета</p>
                                                                    </td>
                                                                    <td width="166" height="28">
                                                                        <p align="center">Иденты</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="71">777</td>
                                                                    <td width="152">
                                                                        <p align="center">Cccam</p>
                                                                    </td>
                                                                    <td width="127">
                                                                        <p align="center">Все <span lang="ru">пакеты</span></p>
                                                                    </td>
                                                                    <td width="166">
                                                                        <p align="center">Все иденты</p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
