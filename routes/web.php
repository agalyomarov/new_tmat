...
Route::group(['middleware' => ['login']], function () {
   ...
   Route::get('/packet/stop/{client}', [PacketController::class, 'stop'])->name('packet.stop');
...
Route::group(['prefix' => config('app.URL_FOR_ADMIN'), 'as' => 'admin.', 'middleware' => ['login', 'admin']], function () {
   Route::get('/', function () {
